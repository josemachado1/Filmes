namespace Filmes4All.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<FilmesBD>
    {
   ...
   new Filmes {ID=1, Nome="Lady Bird", Ano=2017, Capa="https://bit.ly/2jFKjOP", Descricao="Christine McPherson está no último ano do colégio e o que mais deseja é ir fazer faculdade longe de Sacramento, Califórnia, ideia rejeitada por sua mãe. Lady Bird, como a garota de forte personalidade exige ser chamada, não se dá por vencida e leva o plano de ir embora adiante mesmo assim. Enquanto a hora não chega, ela se divide entre as obrigações estudantis no colégio católico, o primeiro namoro, típicos rituais de passagem para a vida adulta e inúmeros desentendimentos com a progenitora.", PrecoVenda=5, Pontuacao=7.5 },
   new Filmes {ID=2, Nome="Foge", Ano=2017, Capa="https://bit.ly/2KJEFHC", Descricao="Um jovem fotógrafo descobre um segredo sombrio quando conhece os pais aparentemente amigáveis da sua namorada.", PrecoVenda=5, Pontuacao=7.7 },
   new Filmes {ID=3, Nome="Dunkirk", Ano=2017, Capa="https://bit.ly/2jFgJJd", Descricao="Durante a Segunda Guerra Mundial, a Alemanha avança rumo à França e cerca as tropas aliadas nas praias de Dunkirk. Sob cobertura aérea e terrestre das forças britânicas e francesas, as tropas são lentamente evacuadas da praia.", PrecoVenda=5, Pontuacao=8.0 },
   new Filmes {ID=4, Nome="Coco", Ano=2017, Capa="https://bit.ly/2K363PE", Descricao="Miguel é um menino de 12 anos que deseja ser um músico famoso, mas precisa lidar com sua família que desaprova seu sonho. Determinado a virar o jogo, ele acaba desencadeando uma série de eventos ligados a um mistério de 100 anos.", PrecoVenda=5, Pontuacao=8.5 },
   new Filmes {ID=5, Nome="Amor de Improviso", Ano=2017, Capa="https://bit.ly/2I5Em8q", Descricao="O comediante paquistanês Kumail e a estudante de graduação Emily se apaixonam, mas encontram dificuldades quando suas culturas entram em conflito.", PrecoVenda=5, Pontuacao=7.6 },
   new Filmes {ID=6, Nome="Mulher-Maravilha", Ano=2017, Capa="https://bit.ly/2I1J07h", Descricao="Treinada desde cedo para ser uma guerreira imbatível, Diana Prince nunca saiu da paradisíaca ilha em que é reconhecida como princesa das Amazonas. Quando o piloto Steve Trevor se acidenta e cai em uma praia do local, ela descobre que uma guerra sem precedentes está se espalhando pelo mundo e decide deixar seu lar certa de que pode parar o conflito. Lutando para acabar com todas as lutas, Diana percebe o alcance de seus poderes e sua verdadeira missão na Terra.", PrecoVenda=5, Pontuacao=7.5 },
   new Filmes {ID=7, Nome="Logan", Ano=2017, Capa="https://bit.ly/2rqweci", Descricao="Em 2024, os mutantes estão em franco declínio, e as pessoas não sabem o real motivo. Uma organização está transformando as crianças mutantes em verdadeiras assassinas. Wolverine, cansado de tudo e a pedido de um cada vez mais enfraquecido Professor Xavier, precisa proteger a jovem e poderosa Laura Kinney, conhecida como X-23. Enquanto isso, o vilão Nathaniel Essex amplia seu projeto de destruição.", PrecoVenda=5, Pontuacao=8.1 },
   new Filmes {ID=8, Nome="Star Wars: Episódio VIII - Os Últimos Jedi", Ano=2017, Capa="https://bit.ly/2KLseLp", Descricao="A tranquila e solitária vida de Luke Skywalker sofre uma reviravolta quando ele conhece Rey, uma jovem que mostra fortes sinais da Força. O desejo dela de aprender o estilo dos Jedi força Luke a tomar uma decisão que mudará sua vida para sempre. Enquanto isso, Kylo Ren e o General Hux lideram a Primeira Ordem para um ataque total contra Leia e a Resistência pela supremacia da galáxia.", PrecoVenda=5, Pontuacao=7.3 },
   new Filmes {ID=9, Nome="A Forma da Água", Ano=2017, Capa="https://bit.ly/2KMqqSC", Descricao="Elisa é uma zeladora muda que trabalha em um laboratório onde um homem anfíbio está sendo mantido em cativeiro. Quando Elisa se apaixona com a criatura, ela elabora um plano para ajudá-lo a escapar com a ajuda de seu vizinho.", PrecoVenda=5, Pontuacao=7.4 },
   new Filmes {ID=10, Nome="The Florida Project", Ano=2017, Capa="https://bit.ly/2IpMFiG", Descricao="Moonee, uma agitada garotinha, faz novas amizades nas redondezas dos parques Disney. Ela vive com a mãe em uma hospedagem de beira de estrada e as duas contam com a proteção do gerente Bobby na batalha diária pela sobrevivência.", PrecoVenda=5, Pontuacao=7.6 }
};
            filmes.ForEach(ff => context.Filmes.AddOrUpdate(f => f.Nome, ff));
            context.SaveChanges();
   ...
   new Cliente {ID=1, Nome=" João Santos", Telemovel="912039720", DataNascimento=new DateTime(1965,2,21), Morada="Praceta Conde Arnoso 98 - Lisboa" },
   new Cliente {ID=2, Nome=" Daniel Soares", Telemovel="928155823", DataNascimento=new DateTime(1966,7,19), Morada="R Principal 107 - Guarda" },
   new Cliente {ID=3, Nome=" Adriana Rodrigues", Telemovel="922775155", DataNascimento=new DateTime(1981,12,3), Morada="Avenida Julio S Dias 55 - Porto" },
   new Cliente {ID=4, Nome=" Rosa Fernandes", Telemovel="913055221", DataNascimento=new DateTime(1977,9,24), Morada="Rua Telheiro 104 - Setubal" },
   new Cliente {ID=5, Nome=" Carolina Oliveira", Telemovel="938070118", DataNascimento=new DateTime(1953,8,17), Morada="R Centieira 26 - Coimbra" },
   new Cliente {ID=6, Nome=" César Sousa", Telemovel="916118589", DataNascimento=new DateTime(1964,8,22), Morada="Avenida Visconde Valmor 14 - Lisboa" }
   ...
   new Carrinho {ID=1, Quantidade=1, PrecoCompra=5,FilmeFK=1},
   new Carrinho {ID=2, Quantidade=5, PrecoCompra=5,FilmeFK=2},
   new Carrinho {ID=3, Quantidade=3, PrecoCompra=5,FilmeFK=3},
   new Carrinho {ID=4, Quantidade=6, PrecoCompra=5,FilmeFK=4},
   new Carrinho {ID=5, Quantidade=2, PrecoCompra=5,FilmeFK=5},
   new Carrinho {ID=6, Quantidade=4, PrecoCompra=5,FilmeFK=6},
